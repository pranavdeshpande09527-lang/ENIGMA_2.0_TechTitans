...
export default function WeeklyReportCard({ aqiData, profile, predictedPm25, predictedPm10, fetchedWeather }) {
    ...
    return (
        <div className="bg-surface-card shadow-premium border border-brand-sand backdrop-blur-md rounded-2xl p-6 shadow-xl mb-6 text-ink-dark relative overflow-hidden">
            {/* Background Glow */}
            ...
            <div className="flex justify-between items-center mb-6 relative z-10">
                ...
                {!report && (
                    <button
                        ...
                        disabled={loading}
                        className="px-5 py-2 text-sm bg-gradient-to-r from-primary-600 to-primary-500 hover:from-primary-500 hover:to-primary-400 font-bold rounded-lg shadow-lg disabled:opacity-50 transition-all"
                    >
            ...
            {report && (
                <div className="animate-slide-up space-y-6 relative z-10">
                    {/* Header Risk Block */}
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div className="bg-gray-900/40 p-5 rounded-2xl border border-brand-sand flex flex-col items-center justify-center text-center">
                        ...
                        {/* Trend Graph & Summary */}
                        <div className="bg-gray-900/40 p-5 rounded-2xl border border-brand-sand flex flex-col justify-between">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        {/* Summary Stats Grid */}
                        <div className="bg-gray-900/40 p-5 rounded-2xl border border-brand-sand">
                        ...
                        <div className="flex flex-col gap-4">
                            <div className="bg-primary-900/20 border border-primary-500/30 p-4 rounded-xl flex-1">
                            ...
                            <div className="bg-danger-900/20 border border-danger-500/30 p-4 rounded-xl flex-1">
                            ...
                            <div className="bg-safe-900/20 border border-safe-500/30 p-4 rounded-xl flex-1">
                    ...
                    <div className="flex justify-end border-t border-brand-sand pt-4 mt-2">
